...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> ChineseTable = new()
    {
        ...
        ["Glow only on refresh, hover, or limit alerts."] = "仅在刷新、悬停或限额告警时发光。",
        ...
        ["Include local token cost/value as a swipe page in the island."] = "把本地 token 成本作为岛屿的一个滑动页。",
        ["Wide"] = "宽",
        ...
        ["Input + output"] = "输入 + 输出",
        ["Token counting"] = "Token 口径",
        ["Counts everything — input, output, and cache. Mirrors ccusage."] = "统计全部——输入、输出与缓存。对齐 ccusage。",

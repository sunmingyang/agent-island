...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> ChineseTable = new()
    {
        ...
        ["AgentIsland {0} is currently the newest version available."] = "AgentIsland {0} 是当前的最新版本。",
        ...
        ["less"] = "少",
        ["more"] = "多",
        ["Details unavailable right now."] = "详情暂时不可用。",
        ["Earned resets appear here with their expiry."] = "获得的重置卡会显示在这里，附带有效期。",
        ["expired"] = "已过期",
        ["valid {0} · {1}"] = "有效 {0} · {1}",
        ["{0} {1} reached"] = "{0} {1}已用尽",
        ...
        ["Pinned to a specific display. Falls back to Auto if unplugged."] = "已固定到指定显示器；拔出后回退为自动。",
        ["Position"] = "位置",

...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> ChineseTable = new()
    {
        ...
        ["Top or bottom bar, a free-floating widget you drag anywhere, or docked by the tray."] = "顶部或底部条、可任意拖动的悬浮小窗，或停靠在托盘旁。",
        ["Top bar"] = "顶部条",
        ["Bottom bar"] = "底部条",
        ["Floating window"] = "悬浮小窗",
        ["By the tray"] = "托盘旁",
        ["Drag the island to move it; its spot is remembered."] = "拖动灵动岛即可移动，位置会被记住。",
        ["Island edge"] = "停靠边缘",
        ["Dock to the top of the screen like the Mac notch, or to the bottom above the taskbar."] = "像 Mac 刘海一样贴屏幕顶部，或停靠在底部任务栏上方。",
        ["Top"] = "顶部",
        ["Bottom"] = "底部",
        ["Alignment"] = "对齐",
        ["Left"] = "靠左",

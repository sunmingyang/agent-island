...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> ChineseTable = new()
    {
        ...
        ["Download"] = "去下载",
        ["Later"] = "以后再说",
        ["Open threads via"] = "跳转方式",
        ["CLI resume lands on the exact conversation in a terminal; the Desktop app waits on Anthropic's deep link."] = "CLI 恢复会在终端里精确续上那条对话；桌面应用要等 Anthropic 开放深链",
        ["The desktop app jumps straight to the exact thread; CLI resume reopens it in a terminal instead."] = "桌面应用直达具体线程；CLI 恢复则改在终端里重开",
        ["Open Claude sessions with"] = "Claude 会话跳转方式",
        ["CLI resume lands on the exact conversation in a terminal; the Desktop app can't jump to a specific chat until Anthropic unlocks its deep link."] = "CLI 恢复会在终端里精确续上那条对话；桌面应用要等 Anthropic 开放深链后才能直达具体会话",
        ["CLI resume"] = "CLI 恢复",
        ["Desktop app"] = "桌面应用",
        ["Quota shows"] = "额度显示",
        ["Used"] = "已用",
    ...
    private static readonly Dictionary<string, string> EnglishTable = new()
    {
        ...
        ["CLI resume lands on the exact conversation in a terminal; the Desktop app waits on Anthropic's deep link."] = "CLI resume lands on the exact conversation in a terminal; the Desktop app waits on Anthropic's deep link",
        ["The desktop app jumps straight to the exact thread; CLI resume reopens it in a terminal instead."] = "The desktop app jumps straight to the exact thread; CLI resume reopens it in a terminal instead",
        ["CLI resume lands on the exact conversation in a terminal; the Desktop app can't jump to a specific chat until Anthropic unlocks its deep link."] = "CLI resume lands on the exact conversation in a terminal; the Desktop app can't jump to a specific chat until Anthropic unlocks its deep link",
        ...
        ["Collapse the hidden side and pull the visible logo to the middle, instead of keeping the symmetric layout."] = "Collapse the hidden side and pull the visible logo to the middle, instead of keeping the symmetric layout",
